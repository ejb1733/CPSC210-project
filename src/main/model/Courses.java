...
public abstract class Courses {
    ...
    ArrayList<Course> prereq121210 = new ArrayList<>(Arrays.asList(cpsc121, cpsc210));
    Course cpsc213 = new Course("CPSC 213", prereq121210);
    Course cpsc221 = new Course("CPSC 221", prereq121210);
    ...
    ArrayList<Course> prereq213211 = new ArrayList<>(Arrays.asList(cpsc213, cpsc221));
    ...
    Course cpsc310 = new Course("CPSC 310", prereq213211);
    Course cpsc311 = new Course("CPSC 311", prereq210);
    Course cpsc312 = new Course("CPSC 312", prereq210);
    Course cpsc313 = new Course("CPSC 313", prereq213211);
    Course cpsc314 = new Course("CPSC 314", prereq221);
    Course cpsc317 = new Course("CPSC 317", prereq213211);
    ...
    ArrayList<Course> prereq213304 = new ArrayList<>(Arrays.asList(cpsc213, cpsc304));
    ArrayList<Course> prereq213221311 = new ArrayList<>(Arrays.asList(cpsc213, cpsc221, cpsc311));
    ArrayList<Course> prereq313317 = new ArrayList<>(Arrays.asList(cpsc313, cpsc317));
    ArrayList<Course> prereq313320 = new ArrayList<>(Arrays.asList(cpsc313, cpsc320));
    ArrayList<Course> prereq221320 = new ArrayList<>(Arrays.asList(cpsc221, cpsc320));
    ArrayList<Course> prereq310344 = new ArrayList<>(Arrays.asList(cpsc310, cpsc344));
    Course cpsc402 = new Course("CPSC 402", prereq302);
    Course cpsc404 = new Course("CPSC 404", prereq213304);
    Course cpsc406 = new Course("CPSC 406", prereq313);
    Course cpsc410 = new Course("CPSC 410", prereq310);
    Course cpsc411 = new Course("CPSC 411", prereq213221311);
    Course cpsc415 = new Course("CPSC 415", prereq313);
    Course cpsc416 = new Course("CPSC 416", prereq313317);
    Course cpsc417 = new Course("CPSC 417", prereq313317);
    Course cpsc418 = new Course("CPSC 418", prereq313320);
    Course cpsc420 = new Course("CPSC 420", prereq320);
    Course cpsc421 = new Course("CPSC 421", prereq221320);
    ...
    Course cpsc444 = new Course("CPSC 444", prereq310344);
